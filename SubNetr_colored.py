...
# display subnet information on choosen NIC
def subNIC(x):
    ...
    print(Fore.WHITE, Back.GREEN)   # wrap output in white text, green background
...
# graphically display IP Addresses in arp cache
def arpSpotter(x):
...
# main
def main():
    # 2. print the banner right off the bat
    PrintBanner()
